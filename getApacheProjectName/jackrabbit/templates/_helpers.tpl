...
{{ include "jackrabbit.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "jackrabbit.selectorLabels" -}}
...
*/}}
{{- define "jackrabbit.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "jackrabbit.fullname" .) .Values.serviceAccount.name }}
{{- else }}
